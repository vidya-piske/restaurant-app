...
const MenuPage = () => {
    ...
    const handleInputChange = (e, field) => {
        ...
        validateForm(); // Validate form after each input change
    };

    const validateForm = () => {
        // Basic validation for demonstration purpose
        const isValid = Object.values(editedValues).every(value => value.trim() !== ''); // Check if all values are non-empty
            ...
            <Space>
                ...
                >
                  <Modal
                        ...
                        okButtonProps={{ disabled: !isFormValid }} // Disable OK button if form is invalid
                    >
